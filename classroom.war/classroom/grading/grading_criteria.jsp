...
<t:content title="Grade Settings">
   ...
   <jsp:attribute name="script">
		$register({id:"edit_criteria", page:"classroom/grading/edit_criteria.jsp", title:"Grading Criteria", context:"edit_criteria", options:{width:500,height:400}});
		$register({id:"edit_period", page:"classroom/grading/edit_period.jsp", title:"Grading Period", context:"edit_period", options:{width:600,height:400}});
		$register({id:"edit_eq", page:"classroom/grading/edit_eq.jsp", title:"Grading Equivalents", context:"edit_eq", options:{width:350,height:500}});
