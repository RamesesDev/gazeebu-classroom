...
<t:content>
	...
	<jsp:attribute name="title">
		<a href="#classrecord:classrecord" style="font-size:10px;"><< Back</a><br>
		Class Record
	</jsp:attribute>
	...
	<jsp:attribute name="script">
		$register( {id:"#classrecord_activity", context:"classrecord_activity"} );
		...
		$register( {id:"new_activity", page:"apps/classrecord/new_activity.jsp", context:"new_activity"} );
		
		$put("classrecord_activity",
			new function() {
				...
				this.changeContext = function() {
					return new DropdownOpener("#classrecord_activity");
				}
				this.applyContextChange = function() {
					WindowUtil.loadHash( "classrecord:classrecord_activity", this.qry );
					return "_close";
				}
			}
		);
	...
	<jsp:attribute name="sections">
		<div style="display:none" id="classrecord_activity">
			Context is :
			Term: <select r:context="classrecord_activity" r:name="qry.termid"  r:items="termList" r:itemLabel="term" r:itemKey="objid"></select><br>
			Activity Type: <select r:context="classrecord_activity" r:name="qry.criteriaid"  r:items="criteriaList" r:itemLabel="title" r:itemKey="objid"></select><br>
			<input type="button" r:context="classrecord_activity" r:name="applyContextChange" value="Apply"/>
		</div>
	</jsp:attribute>	
	
	<jsp:attribute name="actions">
		<label r:context="classrecord_activity">term : #{qry.termid} criteria: #{qry.criteriaid}</label> 
		<input type="button" r:context="classrecord_activity" r:name="addEntry" value="Add Entry" /> 
	</jsp:attribute>
	...
	<jsp:body>
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td>Activity Type: </td>
				<td><a r:context="classrecord_activity" r:name="changeContext">Change</a></td>
			</tr>
		</table>
			...
			<tr>
				...
				<c:forEach items="${INFO.activities}" var="item" varStatus="stat">
					<td align="center" width="60" title="${item.title}" id="${stat.index % 2 == 0 ? 'odd-col' : 'even-col'}">
						<a r:context="classrecord_activity" r:name="editEntry" r:params="{activityid: '${item.objid}'}">
